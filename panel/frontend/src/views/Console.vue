  ...
  <el-row :gutter="16">
    <el-col :xs="24" :md="10">
      <el-card>
        ...
        <el-button type="primary" style="margin-top: 12px" :icon="Promotion" @click="announce">发送广播</el-button>
      </el-card>
      <el-card style="margin-top: 16px;">
        ...
        <el-popconfirm title="确定倒计时关服?" @confirm="shutdown" width="220">
          <template #reference><el-button type="danger" :icon="SwitchButton">关服</el-button></template>
        </el-popconfirm>
      </el-card>
    </el-col>
    <el-col :xs="24" :md="14">
      <el-card class="log-card">
        ...
        <pre class="logs pal-mono">{{ logs || '暂无日志' }}</pre>
      </el-card>
    </el-col>
  </el-row>
</template>
...
import { Refresh, Promotion, SwitchButton } from '@element-plus/icons-vue'
import api from '../api'
...
.logs {
  ...
  padding: 12px; border-radius: var(--pal-radius-sm);
  height: 480px; overflow: auto; font-size: 12px; line-height: 1.6;
